...
import type {ICastResponse} from "../models/cast/ICastResponse.ts";
...
export const getCast=async(id:number):Promise<ICast[]> =>{
     const{data}=await axiosInstance.get<ICastResponse>(`/movie/${id}/casts`,{})
    return data.cast;
